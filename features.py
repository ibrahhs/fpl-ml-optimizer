...
def build_player_table(bootstrap, fixtures, gw: int):
    ...
    # Opponent difficulty average for the team in this GW
    def opp_diff(row):
    ...
    # Engineered features and proxy target
...
def horizon_expected_points(bootstrap, fixtures, start_gw: int, horizon: int, model_fn):
    """Sum expected points over a horizon with small decay; robust to missing GW data."""
    agg = None
